...
<html lang="en">
  <head>
      ...
      <!-- AdSence -->
      <script data-ad-client="ca-pub-5161253344039226" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    ...
    <title>  Manchester City - Home :  Buy yarn, Sell yarn, Buy Loom, Sell Loom, Buy mill store, sell mill store, mill store, yarn, loom, powerloom, textile, ichalkaranji, manchester city, seller, textile market  <?php $title = 'Home' ?>
    </title>
  </head>
  <body>
                   ...
                   echo '<div class = "product">';
                       ...
                       echo '<div class = "product-info">';
                          ...
                          echo '<p>Store: ' . $store . '</p>';
                           ...
                           echo '<p class = "product-price "><del>' . $productPrice .'</del></p>';
                           echo '<p class = "product-price">' . $displayPrice.'Rs.</p>';
