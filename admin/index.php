...
<html lang="en">
  <head>
    ...
    <script src="https://kit.fontawesome.com/a8d16a9f7c.js" crossorigin="anonymous"></script>

    <title>Manchester City - Admin<?php $title="Sellers"; ?></title>
  </head>
  <body>
          ...
          if(!isset($err)) 
          {
            ...
            while($finalRes = mysqli_fetch_array($result))
            {
              ...
              echo '<tr>';     
                ...
                echo '<td><input type="submit" value="View" name="view" class="btn btn-success mb-2">
<input type="submit" value="Remove Seller" class = "btn btn-outline-danger" name="remove"></td>';
              echo '</tr>';
              echo '</form>';
