...
<html>
	...
	<body>
		<a href="yourorders.php"><button style="padding:10px; outline:none; margin:10px; cursor:hover;" id="backBtn">Back</button></a>
   ...
   <article>
    ...
    else if(isset($_POST['remove']))
    {
       ...
       if(!isset($err)) 
       {
           ...
           echo '<script>location.replace("yourorders.php");</script>';
       }
       else
       {
