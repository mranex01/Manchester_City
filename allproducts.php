...
<html lang="en">
  <head>
    ...
    <title>Manchester City - All Products : yarn,manchester,loom,powerloom,ichalkaranji,mill store,buy,sell,shop,store,yarn,meaning,yarn meaning in marathi,yarn architecture,yarn meaning in hindi,yarn vs npm, Buy yarn, Sell yarn, Buy Loom, Sell Loom, Buy mill store, sell mill store, mill store, yarn, loom, powerloom, textile, ichalkaranji, manchester city, seller, textile market, products, all products <?php $title = 'All Products' ?></title>
  </head>
  <body>
...
<?php
    ...
    $query = "SELECT * FROM `products` WHERE `activationStatus` = 'activated'";
