...
<html lang="en">
  <head>
    ...
    <title>Manchester City - Products - Mill Store <?php $title = 'Products'; ?></title>
...
<!--**************************************  Main Section ****************************************************************-->
     ...
     <main>
       ...
       <div class="subNav" style="display:flex;">
          ...
          <div class="mill btn btn-primary" >Mill</div>
      </div>
  ...
  <div class = "products">
    ...
    $query = "SELECT * FROM `products` WHERE `email` = '$email' AND `productCat` = 'Mill Store'";
