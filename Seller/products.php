...
<html lang="en">
  <head>
    ...
    <title>Manchester City - Products - Loom <?php $title = 'Products'; ?></title>
...
<!--**************************************  Main Section ****************************************************************-->
     ...
     <main>
      ...
      <div class="subNav" style="display:flex;">
          <div class="loom btn btn-primary">Loom</div>
          <div class="yarn btn btn-outline-primary" onclick="location.replace('productsYarn.php');">Yarn</div>
  ...
  <div class = "products">
    ...
    $query = "SELECT * FROM `products` WHERE `email` = '$email' AND `productCat` = 'Loom'";
                  ...
                  <button onclick="document.getElementById('deactivateConfirmBox<?php echo $id;?>').style.display='block';" data-toggle="modal" data-target="#activateConfirmBox<?php echo $id;?>" style="position:absolute; top:0; right:0;" type = "button"class = "btn-buy btn btn-outline-success" value="Activate">Activate</button>
                   ...
                   echo '<div class = "product-info">';
                       echo '<div class = "product-info-top">';
                           ...
                           if($productQuantity <= 0){echo '<font color="red"><b>Out of Stock</b></font>';}
                       echo '</div>';
                       echo '<a href = "#" class = "product-name">' . $productName . '</a>';
                       echo '<div class = "product-info-top">' . $productDetails . '</div>';
